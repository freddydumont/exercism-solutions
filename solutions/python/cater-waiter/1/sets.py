...
from sets_categories_data import (  # noqa: F401
    ALCOHOLS,
    KETO,
    OMNIVORE,
    PALEO,
...
def check_drinks(drink_name: str, drink_ingredients: list[str]) -> str:
    ...
    """
    is_alcohol_free = ALCOHOLS.isdisjoint(drink_ingredients)

    return f"{drink_name} {'Mocktail' if is_alcohol_free else 'Cocktail'}"
...
def categorize_dish(dish_name: str, dish_ingredients: set[str]) -> str | None:
    ...
    for ingredients, category in categories:
